...
import { createNodeOutput } from './output.js';
 ...
 */
async function runCommand(run, args, ctx, output) {
    try {
        await run(args, ctx);
        return 0;
    }
...
function printHelp(output, commands, agents) {
...
function parseArgs(argv, argDefs) {
    const args = {};
